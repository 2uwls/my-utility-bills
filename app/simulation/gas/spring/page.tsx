...
export default function SpringGasSimulationPage() {
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm opacity-90">봄철 기준</p>
              </div>
          ...
          <CardContent>
            <div className="grid grid-cols-4 gap-2">
              ...
              <Link href="/simulation/gas/spring">
                <Button variant="default" className="h-12 rounded-xl bg-green-500 hover:bg-green-600 text-white w-full">
                  <div className="flex items-center gap-2">
        ...
        <Card className="border-0 rounded-2xl bg-white">
          <CardHeader>
            ...
            <CardDescription>봄철 전환기 절약 방법</CardDescription>
          </CardHeader>
