...
export default function FallGasSimulationPage() {
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm opacity-90">가을철 기준</p>
              </div>
          ...
          <CardContent>
            <div className="grid grid-cols-4 gap-2">
              ...
              <Link href="/simulation/gas/fall">
                <Button
                  variant="default"
                  className="h-12 rounded-xl bg-orange-500 hover:bg-orange-600 text-white w-full"
                >
                  <div className="flex items-center gap-2">
        ...
        <Card className="border-0 rounded-2xl bg-white">
          <CardHeader>
            ...
            <CardDescription>가을철 난방 준비</CardDescription>
          </CardHeader>
