...
import { ArrowLeft, Flame, TrendingUp, AlertCircle, Droplets, CreditCard, Calendar, Snowflake, Sun } from "lucide-react"
...
export default function SummerGasSimulationPage() {
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm opacity-90">여름철 기준</p>
              </div>
          ...
          <CardContent>
            <div className="grid grid-cols-4 gap-2">
              ...
              <Link href="/simulation/gas/summer">
                <Button
                  variant="default"
                  className="h-12 rounded-xl bg-yellow-500 hover:bg-yellow-600 text-gray-900 w-full"
                >
                  <div className="flex items-center gap-2">
                    <Sun className="h-4 w-4" />
        ...
        <Card className="border-0 rounded-2xl bg-white">
          <CardHeader>
            ...
            <CardDescription>온수 사용 절약 팁</CardDescription>
          </CardHeader>
