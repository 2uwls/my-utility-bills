...
import { ArrowLeft, Clock, Calculator, Flame, Gift, Home, Percent, Zap } from "lucide-react"
      ...
      <div className="max-w-xl mx-auto px-4 py-6 space-y-6">
        ...
        <Card className="border-0 rounded-2xl bg-[#FFE300] text-gray-700">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <div className="text-2xl font-bold">₩{calculateDiscountedElectricBill().toLocaleString()}</div>
        ...
        <Card className="border-0 rounded-2xl bg-white">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="h-48">
              <ResponsiveContainer className="border border-gray-200 rounded-xl p-4 pt-6" width="100%" height="100%">
                <BarChart data={timeBasedRates}>
                  ...
                  />
                  <Bar dataKey="일반형" fill={contractType === "general" ? "#FFE300" : "#666666"} name="일반형" />
                  <Bar dataKey="심야형" fill={contractType === "night" ? "#FFE300" : "#666666"} name="심야형" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl mb-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <div className="font-bold text-gray-900">누진제 구간 변경</div>
                          <div className="text-sm text-gray-600">{currentTier}구간 → 1구간 적용</div>
                        </div>
                      </div>
                      <Switch
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
              ...
              <div className="flex items-center gap-2">
                <a href="https://en-ter.co.kr/ec/main/main.do" target="_blank" rel="noopener noreferrer">
                  <Button
                    variant="ghost"
                    size="sm"
