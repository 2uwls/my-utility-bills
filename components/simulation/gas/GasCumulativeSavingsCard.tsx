...
interface GasCumulativeSavingsCardProps {
  generateCumulativeData: () => any[];
  calculateTotalSavings: () => number;
}

export default function GasCumulativeSavingsCard({ generateCumulativeData, calculateTotalSavings }: GasCumulativeSavingsCardProps) {
  return (
      ...
      <CardContent>
        ...
        <div className="mt-4 p-4 bg-gray-50 rounded-xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
            ...
            <div className="text-xl sm:text-2xl font-bold text-gray-900 mt-2 sm:mt-0">
